...
fn main() {
    ...
    let mnt6_mod = MNT4BigFr::from(MNT6BigFr::MODULUS);
    println!("mnt6_mod = {}", mnt6_mod);

    let secret_hack: MNT4BigFr = from_file("./leaked_secret.bin");
    let secret_hack = mnt6_mod - secret_hack;
